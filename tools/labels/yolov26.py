#!/usr/bin/env python3
"""Write the class vocabulary for each YOLO26 variant into the local ``weights/`` tree.

    python tools/labels/yolov26.py                 # every fetched variant
    python tools/labels/yolov26.py nano small
