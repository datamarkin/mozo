#!/usr/bin/env python3
"""Write the class vocabulary for each YOLO12 variant into the local ``weights/`` tree.

    python tools/labels/yolov12.py                 # every fetched variant
    python tools/labels/yolov12.py nano small
