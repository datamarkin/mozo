...
from ..utilities.tensors import NestedTensor, nested_tensor_from_tensor_list
from ._types import BuilderArgs
...
def build_model(args: "BuilderArgs") -> LWDETR | tuple[Any, None, None]:
    ...
    # ModelSpec derives num_feature_levels in __post_init__ and is frozen, so it is read here rather
    # than assigned onto the caller's spec.
