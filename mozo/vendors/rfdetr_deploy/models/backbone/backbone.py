...
from ...utilities.tensors import NestedTensor
...
class Backbone(BackboneBase):
    ...
    def export(self) -> None:
        ...
        # Upstream also merges LoRA adapters here via `peft`. This build has no fine-tuning path, so the encoder is
        # never a PeftModel and the merge would be a no-op — dropping it keeps `peft` out of the dependency set.
